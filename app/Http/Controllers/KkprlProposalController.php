...
class KkprlProposalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'existing_doc_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png,doc,docx|max:30720',
            'site_plan_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'location_map_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'accessibility_map_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'hydro_oceanography_doc_path' => 'nullable|file|mimes:pdf,doc,docx|max:30720',
            'mangrove_doc_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'seagrass_doc_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'coral_reef_doc_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'land_certificate_path' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:30720',
            'socialization_doc_path' => 'nullable|file|mimes:pdf,doc,docx,jpg,jpeg,png|max:30720',
            'other_supporting_doc_path' => 'nullable|file|mimes:pdf,doc,docx,jpg,jpeg,png|max:30720',
