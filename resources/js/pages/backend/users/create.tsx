...
export default function UsersCreate() {
    ...
    return (
        <MainLayout pageTitle="Tambah User">
            ...
            <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-xl font-bold text-slate-900 leading-none">Tambah User</h1>
                    <p className="text-sm text-slate-500 mt-0.5">Buat akun pengguna baru.</p>
                </div>
            </div>
