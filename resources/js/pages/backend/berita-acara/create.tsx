...
export default function CreateBeritaAcara({ staffList, konsultasi }: Props) {
    ...
    const goToStep2 = () => {
        // Basic step-1 validation gate (server will revalidate)
    ...
    useEffect(() => {
        if (konsultasi) {
            setForm({ ...form,
                ...
                contact_email: konsultasi?.email,
                province: konsultasi?.provinsi,
                regency: konsultasi?.kabupaten,
            });
        }
    }, [konsultasi]);
                    ...
                    {[
                        ...
                        <div key={n} className="flex items-center gap-2 flex-1">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-[10px] text-slate-400">Langkah {n}</p>
                            </div>
