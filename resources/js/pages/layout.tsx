            ...
            >
                <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-6 py-3 lg:px-8">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="ml-1 hidden h-8 shrink-0 items-center border-l border-slate-200 pl-3 lg:flex">
                            <img src={logo_klp} alt="Logo KLP" className="h-full object-contain" />
                        </div>
                                    ...
                                    <div className="relative flex flex-col justify-between bg-gradient-to-br from-blue-600 via-blue-700 to-[#0B1F3A] p-6 text-white lg:col-span-4">
                                        <div>
                                            ...
                                            <p className="mt-1.5 text-xs leading-relaxed text-white/70">
                                                Layanan asistensi resmi kesesuaian ruang laut secara aman, cepat, dan
                                                transparan.
                                            </p>
                                        </div>
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                <SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-sm">
                    <SheetHeader className="border-b border-slate-100 pb-4">
                        <SheetTitle className="font-serif text-base">e-GeRAI</SheetTitle>
                        <SheetDescription>
